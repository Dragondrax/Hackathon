...
namespace MedicalHealth.Fiap.Function.Persistencia.Atualizar.AgendaMedico
{
    public class FunctionPersistenciaAtualizarAgendaMedico
    {
        private readonly ILogger<FunctionPersistenciaAtualizarAgendaMedico> _logger;

        private readonly IAgendaMedicoPersistenciaRepository _agendaMedicoPersistenciaRepository;

        public FunctionPersistenciaAtualizarAgendaMedico(ILogger<FunctionPersistenciaAtualizarAgendaMedico> logger, IAgendaMedicoPersistenciaRepository agendaMedicoPersistenciaRepository)
        {
            _logger = logger;
            _agendaMedicoPersistenciaRepository = agendaMedicoPersistenciaRepository;
        }

        [Function(nameof(FunctionPersistenciaAtualizarAgendaMedico))]
        public async Task Run(
            [ServiceBusTrigger("persistencia.agenda_medico.atualizar", Connection = "ServiceBusConnection")]
